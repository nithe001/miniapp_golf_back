...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '比赛分组表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4  COMMENT = '比赛报名表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_score`  (
  ...
  `ms_submit_id` int(11) ,
  `ms_match_id` bigint(11)  COMMENT '比赛主键',
  `ms_match_title` varchar(255)  COMMENT '比赛名称',
  `ms_group_id` bigint(11)  COMMENT '比赛分组主键',
  `ms_group_name` varchar(255)  COMMENT '分组名称',
  `ms_user_id` bigint(11)  COMMENT '用户id',
  ...
  `ms_create_user_id` bigint(11)  COMMENT '创建人id',
  `ms_create_time` bigint(20)  COMMENT '创建时间',
  `ms_update_user_id` bigint(11)  COMMENT '更新人id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4  COMMENT = '用户记分mapping表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '比赛用户分组mapping记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4  COMMENT = '球场信息' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4  COMMENT = '球队球友积分表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4  COMMENT = '用户加入球队表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户详细资料表' ROW_FORMAT = Dynamic;
