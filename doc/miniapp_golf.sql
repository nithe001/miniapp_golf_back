...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '比赛报名表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_score`  (
  ...
  `ms_submit_id` int(11) DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户记分mapping表' ROW_FORMAT = Dynamic;
