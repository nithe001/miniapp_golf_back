...
CREATE TABLE `admin_user`  (
  ...
  `au_sex` int(11)  COMMENT '性别',
  `au_age` int(11)  COMMENT '年龄',
  `au_tel` varchar(128)  COMMENT '联系电话',
  `au_email` varchar(128)  COMMENT '邮箱',
  `au_role` bigint(20)  COMMENT '角色',
  `au_is_valid` int(11)  COMMENT '是否有效',
  `au_create_date` bigint(20)  COMMENT '创建时间',
  `au_create_user_id` bigint(20)  COMMENT '创建人id',
  `au_create_user_name` varchar(128)  COMMENT '创建人姓名',
  `au_update_user_id` bigint(20)  COMMENT '更新人id',
  `au_update_user_name` varchar(128)  COMMENT '更新人名称',
  `au_update_date` bigint(20)  COMMENT '更新时间',
  PRIMARY KEY (`au_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3  COMMENT = '后台用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_group`  (
  ...
  `mg_match_id` bigint(20)  COMMENT '赛事id',
  `mg_group_name` varchar(128)  COMMENT '分组名称',
  `mg_create_user_id` bigint(20)  COMMENT '分组创建人id',
  `mg_create_user_name` varchar(128)  COMMENT '分组创建人姓名',
  `mg_create_time` bigint(20)  COMMENT '分组创建时间',
  `mg_update_user_id` bigint(11)  COMMENT '分组更新人id',
  `mg_update_user_name` varchar(128)  COMMENT '分组更新人姓名',
  `mg_update_time` bigint(20)  COMMENT '分组更新时间',
  PRIMARY KEY (`mg_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4  COMMENT = '比赛分组表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_info`  (
  ...
  `mi_type` int(11)  COMMENT '比赛类型：1：团队赛  0：单练',
  `mi_people_num` int(11)  COMMENT '单练同组人数',
  `mi_title` varchar(128)  COMMENT '比赛名称',
  `mi_park_id` int(11)  COMMENT '所选球场的场地id',
  `mi_park_name` varchar(128)  COMMENT '所选球场的场地名称',
  `mi_zone_before_nine` varchar(255)  COMMENT '前9洞打哪个区（A/B/C）',
  `mi_zone_after_nine` varchar(255)  COMMENT '后9洞打哪个区（A/B/C）',
  `mi_digest` varchar(512)  COMMENT '比赛介绍',
  `mi_match_time` bigint(20)  COMMENT '比赛日期/开球时间',
  `mi_content` text  COMMENT '比赛内容',
  `mi_match_open_type` int(11)  COMMENT '观战范围：（1、公开 球友均可见；2、队内公开：参赛者的队友可见；3、封闭：参赛队员可见）',
  `mi_join_open_type` int(11)  COMMENT '参赛范围(1、公开 球友均可报名；2、队内：某几个球队队员可报名；)',
  `mi_report_score_team_id` varchar(255)  COMMENT '成绩上报球队id',
  `mi_hit` int(11)  COMMENT '点击量',
  `mi_apply_end_time` bigint(20)  COMMENT '报名截止时间',
  `mi_create_user_name` varchar(128)  COMMENT '比赛发起人',
  `mi_create_user_id` bigint(20)  COMMENT '比赛发起人id',
  `mi_create_time` bigint(20)  COMMENT '创建时间',
  `mi_update_user_name` varchar(128) COMMENT '更新人名称',
  `mi_update_user_id` bigint(20)  COMMENT '更新人id',
  `mi_update_time` bigint(20)  COMMENT '更新时间',
  PRIMARY KEY (`mi_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5  COMMENT = '赛事活动表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_join_watch_info`  (
  ...
  `mjwi_type` int(11)  COMMENT '类型：0：观战 1：报名',
  `mjwi_match_id` bigint(20)  COMMENT '比赛表主键',
  `mjwi_user_id` bigint(20)  COMMENT '用户主键',
  `mjwi_create_time` bigint(20)  COMMENT '创建时间',
  PRIMARY KEY (`mjwi_id`) USING BTREE
) ENGINE = InnoDB  COMMENT = '比赛报名表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_score`  (
  ...
  `ms_team_id` bigint(20)  COMMENT '球队id',
  `ms_match_id` bigint(20)  COMMENT '比赛主键',
  `ms_match_title` varchar(255)  COMMENT '比赛名称',
  `ms_group_id` bigint(20)  COMMENT '比赛分组主键',
  `ms_group_name` varchar(255)  COMMENT '分组名称',
  `ms_user_id` bigint(20)  COMMENT '用户id',
  `ms_user_name` varchar(128)  COMMENT '用户名',
  `ms_score` int(11)  COMMENT '分数',
  `ms_hole_num` int(11)  COMMENT '球洞号（数字1-18）',
  `ms_hole_total_rod_num` int(11)  COMMENT '本洞总杆',
  `ms_push_rod_num` int(11)  COMMENT '推杆',
  `ms_is_up` int(11)  COMMENT '是否上球道（1：是  0：否）',
  `ms_match_total_rod_num` int(11)  COMMENT '本场总杆',
  `ms_create_user_id` bigint(20)  COMMENT '创建人id',
  `ms_create_time` bigint(20)  COMMENT '创建时间',
  `ms_update_user_id` bigint(20)  COMMENT '更新人id',
  `ms_update_time` bigint(20)  COMMENT '更新时间',
  PRIMARY KEY (`ms_id`) USING BTREE
) ENGINE = InnoDB  COMMENT = '比赛成绩表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_score_user_mapping`  (
  ...
  `msum_match_id` bigint(20)  COMMENT '比赛id',
  `msum_group_id` bigint(20)  COMMENT '邀请人所在分组id',
  `msum_create_user_id` bigint(20)  COMMENT '邀请人id',
  `msum_scorer_id` bigint(20)  COMMENT '记分人id',
  `msum_create_time` bigint(20)  COMMENT '创建时间',
  PRIMARY KEY (`msum_id`) USING BTREE
) ENGINE = InnoDB  COMMENT = '用户记分mapping表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `match_user_group_mapping`  (
  ...
  `mugm_match_id` bigint(20)  COMMENT '赛事id',
  `mugm_user_type` int(11)  COMMENT '用户类型：0：临时分组，1：赛长，2：普通用户',
  `mugm_group_id` bigint(11)  COMMENT '分组id',
  `mugm_group_name` varchar(128)  COMMENT '分组名称',
  `mugm_user_id` bigint(20)  COMMENT '球友用户id',
  `mugm_user_name` varchar(128)  COMMENT '球友用户名',
  `mugm_create_user_id` bigint(20)  COMMENT '分组创建人id',
  `mugm_create_user_name` varchar(128)  COMMENT '分组创建人姓名',
  `mugm_create_time` bigint(20)  COMMENT '分组创建时间',
  PRIMARY KEY (`mugm_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5  COMMENT = '比赛用户分组mapping记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `park_info`  (
  ...
  `pi_update_time` bigint(20)  COMMENT '更新时间',
  `pi_update_user_id` bigint(20)  COMMENT '更新人id',
  `pi_update_user_name` varchar(128)   COMMENT '更新人姓名',
  PRIMARY KEY (`pi_id`) USING BTREE
) ENGINE = InnoDB  COMMENT = '球场信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `park_partition`  (
  ...
  `pp_p_id` bigint(20)  COMMENT '场地表主键',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5  COMMENT = '高尔夫场地分区表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `team_info`  (
  ...
  `ti_logo` varchar(255)  COMMENT '球队LOGO',
  `ti_name` varchar(255)  COMMENT '球队名称',
  `ti_signature` varchar(512)  COMMENT '球队签名',
  `ti_digest` varchar(512)  COMMENT '球队简介',
  `ti_address` varchar(255)  COMMENT '所在地区',
  `ti_slogan` varchar(255)  COMMENT '球队签名(口号)',
  `ti_join_open_type` int(11)  COMMENT '是否有加入审核(1、是（队长审批）  0、否)',
  `ti_info_open_type` int(255)  COMMENT '信息是否公开（1、公开 比赛成绩等向所有球友开放；2、封闭，比赛成绩等向队友开放）',
  `ti_match_result_audit_type` int(255)  COMMENT '比赛成绩审核（1：是  0：否）',
  `ti_create_time` bigint(20)  COMMENT '创建时间',
  `ti_create_user_id` bigint(20)  COMMENT '创建人id',
  `ti_create_user_name` varchar(128)  COMMENT '创建人姓名',
  `ti_update_time` bigint(20)  COMMENT '更新时间',
  `ti_update_user_id` bigint(20)  COMMENT '更新人id',
  `ti_update_user_name` varchar(128)  COMMENT '更新人姓名',
  PRIMARY KEY (`ti_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3  COMMENT = '球队表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `team_user_integral`  (
  ...
  `tui_team_id` bigint(20)  COMMENT '球队主键',
  `tui_user_id` bigint(20)  COMMENT '球友主键',
  PRIMARY KEY (`tui_id`) USING BTREE
) ENGINE = InnoDB  COMMENT = '球队球友积分表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `team_user_mapping`  (
  ...
  `tum_team_id` bigint(20)  COMMENT '球队主键',
  `tum_user_id` bigint(20)  COMMENT '用户id',
  `tum_user_type` int(11)  COMMENT '用户类型（1：队长  0：队员）',
  `tum_type` int(11)  COMMENT '类型（0：待审核，1：审核通过）',
  `tum_create_time` bigint(20)  COMMENT '创建时间',
  `tum_create_user_id` bigint(11)  COMMENT '创建人id',
  `tum_create_user_name` varchar(128)   COMMENT '创建人姓名',
  `tum_update_time` bigint(20)  COMMENT '更新时间',
  `tum_update_user_id` bigint(20)  COMMENT '更新人id',
  `tum_update_user_name` varchar(128)   COMMENT '更新人姓名',
  PRIMARY KEY (`tum_id`) USING BTREE
) ENGINE = InnoDB  COMMENT = '用户加入球队表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_info`  (
  ...
  `ui_open_id` varchar(128)  COMMENT '用户微信的openid',
  `ui_type` int(11)  COMMENT '用户类型(1:理事会，2:委员会，3：普通用户)',
  `ui_headimg` varchar(255)  COMMENT '用户头像（同微信头像）',
  `ui_personalized_signature` varchar(512)  COMMENT '个性签名',
  `ui_longitude` varchar(128)  COMMENT '地理位置：经度',
  `ui_latitude` varchar(128)  COMMENT '地理位置：纬度',
  `ui_real_name` varchar(128)  COMMENT '真实姓名',
  `ui_age` int(11)  COMMENT '年龄',
  `ui_tel_no` varchar(128)  COMMENT '联系电话',
  `ui_email` varchar(128)  COMMENT '邮箱',
  `ui_craduate_school` varchar(255)  COMMENT '毕业学校',
  `ui_craduate_department` varchar(255)  COMMENT '毕业院系',
  `ui_craduate_time` bigint(20)  COMMENT '毕业时间',
  `ui_major` varchar(255)  COMMENT '专业',
  `ui_work_unit` varchar(255)  COMMENT '工作单位',
  `ui_address` varchar(255)  COMMENT '常住地',
  `ui_is_valid` int(11)  COMMENT '是否有效（0：否；1：是）',
  `ui_create_time` bigint(20)  COMMENT '创建时间',
  `ui_create_user_name` varchar(128)  COMMENT '创建人姓名',
  `ui_create_user_id` bigint(11)  COMMENT '创建人id',
  `ui_update_time` bigint(20)  COMMENT '更新时间',
  `ui_update_user_name` varchar(128)  COMMENT '更新人姓名',
  `ui_update_user_id` bigint(11)  COMMENT '更新人用户id',
  PRIMARY KEY (`ui_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5  COMMENT = '用户详细资料表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wechat_user_info`  (
  ...
  `wui_u_id` bigint(20)  COMMENT '用户表主键',
  `wui_subscribe` int(11)  COMMENT '是否订阅该公众号标识（0：未关注；1：关注）',
  `wui_openid` varchar(128)  COMMENT 'openid',
  `wui_nick_name` varchar(128)  COMMENT '昵称',
  `wui_real_name` varchar(128)  COMMENT '真实姓名',
  `wui_phone` varchar(128)  COMMENT '联系电话',
  `wui_sex` varchar(128)  COMMENT '性别',
  `wui_city` varchar(128)  COMMENT '城市',
  `wui_country` varchar(128)  COMMENT '国家',
  `wui_province` varchar(128)  COMMENT '省份',
  `wui_language` varchar(128)  COMMENT '语言',
  `wui_headimgurl` varchar(512)  COMMENT '头像',
  `wui_subscribe_time` bigint(20)  COMMENT '关注时间',
  `wui_unionid` varchar(128)  COMMENT 'unionid',
  `wui_remark` varchar(128)  COMMENT '备注',
  `wui_headimg` varchar(128)  COMMENT '头像本地路径',
  `wui_is_valid` int(11)  COMMENT '是否有效（0:否；1：是）',
  `create_time` bigint(20)  COMMENT '创建时间',
  `update_time` bigint(20)  COMMENT '更新时间',
  `watermark_appid` varchar(128) ,
  `watermark_timestamp` varchar(128) ,
  PRIMARY KEY (`wui_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4  COMMENT = '微信用户表' ROW_FORMAT = Dynamic;
