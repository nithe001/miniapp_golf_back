...
<div class="wrapper">
    <jsp:include page="../include/header.jsp">
        <jsp:param value="nav_export" name="navId"/>
    </jsp:include>
                    ...
                    <div class="box">
                        <div class="box-body">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <c:forEach items="${pageInfo.items}" var="matchInfo" varStatus="s">
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn btn-success" href="admin/export/exportScore?matchId=${matchInfo.miId}">
                                                导出成绩
                                            </a>&nbsp;
                                            </td>
                                        </tr>
                            ...
                            <jsp:include page="../include/pojoPageInfo.jsp">
                                <jsp:param value="admin/export/list" name="act"/>
