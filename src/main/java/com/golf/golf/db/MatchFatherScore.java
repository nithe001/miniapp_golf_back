...
/**
 * MatchfatherScore entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "match_father_score", catalog = "miniapp_golf")
public class MatchFatherScore implements java.io.Serializable {
	...
	/** default constructor */
	public MatchFatherScore() {
	}

	/** full constructor */
	public MatchFatherScore(Long msTeamId, Long msMatchId, String msMatchTitle, Integer msMatchType,
