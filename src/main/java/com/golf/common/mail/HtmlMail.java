...
public class HtmlMail extends Mail {
	...
	//		mail.setFromAddress(Const.EMAIL_FROM_ADDRESS);
			Mail mail = MailHelper.buildHtmlMail("smtp.163.com", "test@163.com", "golf");
			// 发送地址
			mail.setFromAddress("test@163.com");
			// 接受地址
			mail.setToAddress(new String[] { "nmy@golf.com.cn","nmy@golf.com.cn" });
			// 发送时间
			...
			throw new SendFailedException("邮件发送失败！");
		}
	}
}
